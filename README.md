...
This project is an accommodation platform built using the MERN stack (MongoDB, Express.js, React.js, Node.js). Below are some screenshots of the application.
